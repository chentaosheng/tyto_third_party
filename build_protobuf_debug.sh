...
cmake -G Ninja \
    ...
    -DCMAKE_CXX_FLAGS="${CXX_BUILD_FLAGS_DEBUG}" \
...
cmake -G Ninja \
    ...
    -DDCMAKE_INSTALL_PREFIX="${INSTALL_DIR}" \
	-DCMAKE_INSTALL_INCLUDEDIR="${INSTALL_DIR}/include" \
	-DCMAKE_INSTALL_LIBDIR="${INSTALL_DIR}/lib/${BUILD_TYPE}" \
    -DCMAKE_INSTALL_CMAKEDIR="${INSTALL_DIR}/lib/${BUILD_TYPE}/cmake" \
