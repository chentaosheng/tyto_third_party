...
set SOURCE_DIR=%~dp0abseil-cpp-build
set INSTALL_DIR=%~dp0absl
...
set SOURCE_DIR=%~dp0protobuf-build
set INSTALL_DIR=%~dp0protobuf

set ZLIB_INCLUDE_DIR=%~dp0zlib\include\windows
set ZLIB_LIB_FILE=%~dp0zlib\lib\%BUILD_TYPE%\zlibstaticd.lib
